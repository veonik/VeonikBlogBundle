...
class MenuController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('VeonikBlogBundle:Menu')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('VeonikBlogBundle:Menu')->find($id);
     ...
     * @Method("POST")
     * @Template("VeonikBlogBundle:Admin/Menu:new.html.twig")
     */
     ...
     * @Method("POST")
     * @Template("VeonikBlogBundle:Admin/Menu:edit.html.twig")
     */

...
use Veonik\Bundle\BlogBundle\Form\PostType;
...
class PostController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('VeonikBlogBundle:Post')
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('VeonikBlogBundle:Post')->find($id);
     ...
     * @Method("POST")
     * @Template("VeonikBlogBundle:Admin/Post:new.html.twig")
     */
     ...
     * @Method("POST")
     * @Template("VeonikBlogBundle:Admin/Post:edit.html.twig")
     */
    ...
    public function isSlugUniqueAction(Request $request)
    {
        return new JsonResponse(array(
            'unique' => $this->getRepository('VeonikBlogBundle:Post')->isSlugUnique($request->get('slug')))
        );
    }
}

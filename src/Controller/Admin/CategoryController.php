...
use Veonik\Bundle\BlogBundle\Entity\Category;
use Veonik\Bundle\BlogBundle\Form\CategoryType;
...
class CategoryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('VeonikBlogBundle:Category')->findAll();
     ...
     * @Method("POST")
     * @Template("VeonikBlogBundle:Admin/Category:new.html.twig")
     */
    ...
    public function editAction($id)
    {
        ...
        $entity = $em->getRepository('VeonikBlogBundle:Category')->find($id);
     ...
     * @Method("POST")
     * @Template("VeonikBlogBundle:Admin/Category:edit.html.twig")
     */

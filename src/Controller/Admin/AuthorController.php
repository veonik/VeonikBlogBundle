...
use Veonik\Bundle\BlogBundle\Form\AuthorType;
...
class AuthorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('VeonikBlogBundle:Author')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('VeonikBlogBundle:Author')->find($id);
     ...
     * @Method("POST")
     * @Template("VeonikBlogBundle:Admin/Author:new.html.twig")
     */
     ...
     * @Method("POST")
     * @Template("VeonikBlogBundle:Author:edit.html.twig")
     */

...
class Author extends AbstractEntity
{
     ...
     *
     * @ORM\OneToMany(targetEntity="Veonik\Bundle\BlogBundle\Entity\Post", mappedBy="author")
     */
    protected $posts;
     ...
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\OneToMany(targetEntity="Veonik\Bundle\BlogBundle\Entity\Comment", mappedBy="author")
     */
    protected $comments;

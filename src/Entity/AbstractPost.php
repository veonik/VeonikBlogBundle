 ...
 *   "Post" = "Veonik\Bundle\BlogBundle\Entity\Post",
...
abstract class AbstractPost extends AbstractEntity implements \JsonSerializable 
{
     ...
     *
     * @ORM\OneToMany(targetEntity="Veonik\Bundle\BlogBundle\Entity\Comment", mappedBy="post")
     */
    protected $comments;
     ...
     *
     * @ORM\ManyToOne(targetEntity="Veonik\Bundle\BlogBundle\Entity\Author", cascade={"persist"}, inversedBy="posts")
     ...
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\ManyToMany(targetEntity="Veonik\Bundle\BlogBundle\Entity\Category", cascade={"persist"})

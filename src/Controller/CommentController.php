...
use Veonik\Bundle\BlogBundle\Entity\Comment;
use Veonik\Bundle\BlogBundle\Entity\Post;
use Veonik\Bundle\BlogBundle\Form\CommentType;
...
class CommentController extends AbstractBlogController
{
    ...
    {
        $post = $this->getDoctrine()->getManager()->getRepository('VeonikBlogBundle:AbstractPost')
